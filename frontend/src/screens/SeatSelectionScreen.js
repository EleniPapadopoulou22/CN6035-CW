/**Οθόνη επιλογής θέσης για μια παράσταση, εμφανίζει το πλάνο της αίθουσας με τις διαθέσιμες θέσεις και επιτρέπει την κράτηση της επιλεγμένης θέσης
 * Γινεται ξεκάθαρος διαχωρισμός ανάμεσα σε κρατημένες και διαθέσιμες θέσεις και ο χρήστης μπορεί να επιλέξει μόνο όσες είναι διαθέσιμες**/
